...
--SELECT COUNT(*)
FROM dbo.account a
INNER JOIN prodcopy.vw_account b ON a.SSB_CRMSYSTEM_ACCT_ID = b.[new_ssbcrmsystemacctid]
...
WHERE b.SourceSystem = 'CRM_Account' AND ISNULL(a.crm_id, '') != b.ssid --updateme
AND c.[crm_id] IS NULL 
